"""
This is a hack implementation for evaluation on nadir planes 

Mostly copy-paste from Evaluator.py (from MonteFloor) and RoomFormer SceneCAD with small modification to parse ZIND data
"""
...
class NadirFloor_Evaluator():
    ...
    def evaluate_scene(self, room_polys, gt_polys, show=False, name="ours"):
        
        ##print('DEBUG evaluate_scene', room_polys, gt_polys)
        ...
        img_size = (256, 256)
        quant_result_dict = self.get_quantitative(gt_polys_list, ignore_mask_region, room_polys, None, img_size)

        return quant_result_dict

    def get_quantitative(self, gt_polys, ignore_mask_region, pred_polys=None, masks_list=None, img_size=(256, 256)):
        #########internal functions
        def get_room_metric():
            ...
            ##print('Evaluator: s3d_ext room_metric',room_metric)
        ...
        ##print('DEBUG s3d_ext evaluator GT polys',gt_polys)
